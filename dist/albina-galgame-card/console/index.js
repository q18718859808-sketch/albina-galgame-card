...
var Mc = "albina-galgame-card", Nc = "阿尔比娜 Galgame Card", Pc = "打开阿尔比娜前端", Fc = "albinaGalgameCardGameSaveV1", Ic = `https://cdn.jsdelivr.net/gh/q18718859808-sketch/albina-galgame-card@v1.0.11/dist/${Mc}`, Lc = {
	opening_001: {
		chapter: 1,
		sceneId: "opening_001",
		route: "white_canvas",
...
var Hc = 2142, Uc = 260, Wc = 1882, Gc = 48, Kc = 15, qc = [
	0,
	12,
	30,
	60,
...
function dl(e) {
	...
	return [
		...
		},
		{
			...
			coverage: Gc,
			total: Wc,
			detail: "48 个 P4 条目已从标题分类和 manifest 元数据扩写为更可用的桥接提示；它们提升路线可用性，但仍不是源文章级复述或完整剧情复原。",
